...
- [Installation Guidelines](./docs/install.md) :⚙️ This will include step-by-step instructions on setting up the necessary dependencies, installing required libraries, and configuring your environment for running GeoPixel.
